...
class LesPays extends Controller{
    ...
    /**
     * Méthode permettant d'afficher un pays à modifier à partir de son ID
     *
     * @param  int $id
     * @return void
     */
    public function modif(int $id){
        ...
        // On précise la valeur de la CLE PRIMAIRE recherchée 
        $this->Pays->id = array(
            'ID_PAYS' => $id  // Sur PAYS la PK est constituée que d'une COLONNE
        );
    ...
    /**
     * Méthode permettant d'afficher un PAYS à supprimer à partir de son ID
     *
     * @param  int $id
     * @return void
     */
