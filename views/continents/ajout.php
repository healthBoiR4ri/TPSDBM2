...
<head>
    <title>Ajout d'un Continent</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        body {
            background: url('<?= PATH ?>/images/banniere.jpg') no-repeat center center fixed;
...
<body>
    <div class="container">
        ...
        <form action="<?= PATH ?>/continents/ajout_sauve" method="POST">
            ...
            <a href="<?= PATH ?>/continents" class="btn btn-warning">Retour à la liste</a>
        </form>
    </div>
